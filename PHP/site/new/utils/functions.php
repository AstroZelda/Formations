...
function require_class(string $classname) {
    require dirname(__DIR__) . DIRECTORY_SEPARATOR . 'class' . DIRECTORY_SEPARATOR . $classname . '.php';
}

function safe_start_session(): bool {
